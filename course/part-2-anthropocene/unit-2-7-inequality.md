...
**b) Read and Explore:**  
Return to the NetLogo guide you first explored in [Unit 2.2](/course/part-2-anthropocene/unit-2-2-stocks-flows.html) on Stocks and Flows (i.e. Clark, W. C., & Harley, A. G. (2025). NetLogo Guide for Sustainable Development Course. Harvard University. Available [HERE](../course-library/learning-games/netlogo-guide-v2.pdf) in the course library.  
> Review Section 1 “Basic access” and explore Section 5 “NetLogo wealth distribution model.”

**c) Read:**  
Milanovic, B. (2024). The three eras of global inequality, 1820–2020 with the focus on the past thirty years. World Development, 177, 106516. [https://doi.org/10.1016/j.worlddev.2023.106516](https://doi.org/10.1016/j.worlddev.2023.106516). Open access copy [Open-access preprint (SocArXiv)](https://osf.io/preprints/socarxiv/yg2h9).
