...
In [Unit 1.1](/course/part-1-conceptual-challenge/unit-1-1-framework.html), we introduced a simple framework for analyzing nature-society systems. Throughout the rest of Part I of the course, we've explored individual elements of this simple framework in detail: goals for sustainable development (Unit [1.2](/course/part-1-conceptual-challenge/unit-1-2-goals.html)) and resources that constitute the productive base that people can draw on to achieve those goals (Units [1.3](/course/part-1-conceptual-challenge/unit-1-3-natural-resources.html), [1.4](/course/part-1-conceptual-challenge/unit-1-4-anthropogenic-resources.html), and [1.5](/course/part-1-conceptual-challenge/unit-1-5-integrated-assessment.html)). In Part 2 of the course, we moved beyond this simple framework, exploring system dynamics including stocks and flows (Units [2.1](/course/part-2-anthropocene/unit-2-1-system-dynamics.html) and [2.2](/course/part-2-anthropocene/unit-2-2-stocks-flows.html)), nonlinearities and tipping points (Unit [2.3](/course/part-2-anthropocene/unit-2-3-complexity.html)), horizontal connections linking places (Unit [2.4](/course/part-2-anthropocene/unit-2-4-horizontal-connections.html)), vertical connections across levels (Unit [2.5](/course/part-2-anthropocene/unit-2-5-vertical-connections.html)), and actors with their institutions and power (Unit [2.6](/course/part-2-anthropocene/unit-2-6-actors-institutions-power.html)). In this unit, we will synthesize the concepts we have studied in part 2 of the course into a more complex version of the framework we introduced in Unit 1.1. This (evolving) framework is not meant to predict outcomes or serve as a grand theory of everything, rather it highlights what researchers have found useful to examine when studying how nature-society interactions unfold in different contexts. In other words, we use the framework as a helpful ‘checklist’ of elements and relationships worth considering when analyzing nature-society interactions—a first step to asking how we might transform nature-society systems onto more sustainable development pathways (something we will turn to in Part 3 of the course).
